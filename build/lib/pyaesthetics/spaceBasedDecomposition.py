...
if(__name__=='__main__'):
    ...
    img = "/home/giulio/Repositories/pyaesthetics/share/data/44.png"  # Path to a sample image
    ...
    areas = getAreas(img, minArea=10, plot=True, coordinates=True, areatype=True, resize=True, returnbox=True)
